                                ...
                                <form method="POST" action="{{ route('admin.bookings.status', $booking->id) }}">
                                    ...
                                    <select name="status" onchange="this.form.submit()" class="form-select form-select-sm">
                                        @php
                                            ...
                                            if ($current === 'Pending') {
                                                $options = ['Pending', 'Confirmed', 'Completed', 'Cancel'];
                                            } elseif ($current === 'Confirmed') {
                                                $options = ['Confirmed', 'Completed', 'Cancel'];
                                            } elseif ($current === 'Cancel') {
                                                $options = ['Cancel', 'Confirmed'];
                                            } elseif ($current === 'Completed') {
                                                $options = ['Completed']; // No other changes allowed
                                            }
                                        @endphp
